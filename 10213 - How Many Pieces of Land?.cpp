...
int main()
{
    ...
    For(cs,test){
        int n = II ;
        BigInt a = BigInt(n)  *  BigInt(n) *  BigInt(n) *  BigInt(n) ;
        BigInt b = BigInt(6)  *  BigInt(n) *  BigInt(n) *  BigInt(n) ;
        BigInt c = BigInt(23) *  BigInt(n) *  BigInt(n) ;
        BigInt d = BigInt(18) *  BigInt(n) ;
        BigInt e = BigInt(24);
        BigInt ans = a - b + c - d + e ;
        ans /= e ;
        cout << ans << endl;
    }
}
